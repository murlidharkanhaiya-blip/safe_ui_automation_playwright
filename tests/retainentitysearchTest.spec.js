...
const { RetainEntitySearch } = require('../pages/RetainEntitySearch');
const credentials = require('../config/Credential');

test('retainentitysearchTest', async ({ browser }) => {
    ...
    const retainentitysearch = new RetainEntitySearch(page);
    ...
    await  retainentitysearch.verifySearchonretainentityPage();
