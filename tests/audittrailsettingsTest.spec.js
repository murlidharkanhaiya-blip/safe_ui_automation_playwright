...
const { AuditTrailSettings } = require('../pages/AuditTrailSettings');
const credentials = require('../config/Credential');

test('audittrailsettingsTest', async ({ browser }) => {
    ...
    const audittrailsettings = new AuditTrailSettings(page);
   ...
   await audittrailsettings.Verifyaudittrailsetting();
