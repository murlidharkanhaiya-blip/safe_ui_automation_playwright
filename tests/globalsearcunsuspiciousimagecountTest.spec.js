...
const { UnSuspiciousImageCount } = require('../pages/UnSuspiciousImageCount');
const credentials = require('../config/Credential');

test('globalsearcunsuspiciousimagecountTest', async ({ browser }) => {
    ...
    const globalsearcunsuspiciousimagecount = new UnSuspiciousImageCount(page);
    ...
    await globalsearcunsuspiciousimagecount.globalsearchunsuspiciouscountviewmorelink();
