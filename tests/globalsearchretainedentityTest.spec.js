...
const { GlobalSearchRetainedEntity } = require('../pages/GlobalSearchRetainedEntity');
const credentials = require('../config/Credential');

test('globalsearchretainedentityTest', async ({ browser }) => {
    ...
    const globalsearchretainedentity = new GlobalSearchRetainedEntity(page);
    ...
    await globalsearchretainedentity.globalsearchretainentityviewmorelink();
