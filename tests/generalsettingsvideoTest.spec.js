...
const { GeneralSettingsVideo } = require('../pages/GeneralSettingsVideo');
const credentials = require('../config/Credential');

test('generalsettingsvideoTest', async ({ browser }) => {
   ...
   const generalsettingsvideo = new GeneralSettingsVideo(page);
    ...
    await  generalsettingsvideo.generalsettingVideo();
