...
const { RetainVideo } = require('../pages/RetainVideo');
const credentials = require('../config/Credential');

test('retainvideoTest', async ({ browser }) => {
    ...
    const retainvideo = new RetainVideo(page);
    ...
    await retainvideo.verifyretainonvideoondemandPage();
