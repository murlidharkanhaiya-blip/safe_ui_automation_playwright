...
const { GeneralSettingsAudio } = require('../pages/GeneralSettingsAudio');
const credentials = require('../config/Credential');

test('generalsettingsaudioTest', async ({ browser }) => {
   ...
   const generalsettingsaudio = new GeneralSettingsAudio(page);
    ...
    await  generalsettingsaudio.generalsettingAudio();
