...
const { FilterChipOnDemandMediaVideo } = require('../pages/FilterChipOnDemandMediaVideo');
const credentials = require('../config/Credential');

test('filterchipondemandmediavideoTest', async ({ browser }) => {
   ...
   const filterchipondemandmediavideo = new FilterChipOnDemandMediaVideo(page);
    ...
    await  filterchipondemandmediavideo.verifyondemandnediavideofilterchip();
