...
const { GlobalSearchNoiseActivity } = require('../pages/GlobalSearchNoiseActivity');
const credentials = require('../config/Credential');

test('globalsearchnoiseactivityTest', async ({ browser }) => {
    ...
    const globalsearchnoiseactivity = new GlobalSearchNoiseActivity(page);
    ...
    await globalsearchnoiseactivity.globalsearchnoiseactivityviewmorelink();
