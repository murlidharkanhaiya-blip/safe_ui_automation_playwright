...
const { BulkUploadSearch } = require('../pages/BulkUploadSearch');

test('bulkuploadsearchTest', async ({ browser }) => {
    ...
    const bulkuploadsearch = new BulkUploadSearch(page);
    ...
    // Step 4: Run bulkupload search verification
    await bulkuploadsearch.verifySearchOnbulkuploadPage();
