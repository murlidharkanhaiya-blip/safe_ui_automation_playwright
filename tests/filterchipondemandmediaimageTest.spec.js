...
const { FilterChipOnDemandMediaImage } = require('../pages/FilterChipOnDemandMediaImage');
const credentials = require('../config/Credential');

test('filterchipondemandmediaimageTest', async ({ browser }) => {
   ...
   const filterchipondemandmediaimage = new FilterChipOnDemandMediaImage(page);
    ...
    await  filterchipondemandmediaimage.verifyondemandnediaimagefilterchip();
