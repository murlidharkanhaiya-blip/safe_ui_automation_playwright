...
const { DeleteRetainImage } = require('../pages/DeleteRetainImage');
const credentials = require('../config/Credential');

test('deleteretainimageTest', async ({ browser }) => {
    ...
    const deleteretainimage = new DeleteRetainImage(page);
    ...
    await deleteretainimage.deleteretainimagesingroup();
