...
const { SuspiciousVideo } = require('../pages/SuspiciousVideo');
const credentials = require('../config/Credential');

test('suspiciousvideoTest', async ({ browser }) => {
    ...
    const suspiciousvideo = new SuspiciousVideo(page);
    ...
    await suspiciousvideo.suspiciousactivitycard();
