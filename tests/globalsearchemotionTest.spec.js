...
const { GlobalSearchEmotion } = require('../pages/GlobalSearchEmotion');
const credentials = require('../config/Credential');

test('globalsearchemotionTest', async ({ browser }) => {
    ...
    const globalsearchemotion = new GlobalSearchEmotion(page);
    ...
    await globalsearchemotion.globalsearchemotionviewmorelink();
