...
const { ManageUserSearch } = require('../pages/ManageUserSearch');
const credentials = require('../config/Credential');

test('manageusersearchTest', async ({ browser }) => {
    ...
    const manageusersearch = new ManageUserSearch(page);
    ...
    // Step 4: Run Manage user search verification
    await manageusersearch.verifySearchOnmanageuserPage();
