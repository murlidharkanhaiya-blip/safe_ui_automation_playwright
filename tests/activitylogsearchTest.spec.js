...
const { ActivityLogSearch } = require('../pages/ActivityLogSearch');
const credentials = require('../config/Credential');

test('activitylogsearchTest', async ({ browser }) => {
    ...
    const activitylogsearch = new ActivityLogSearch(page);
    ...
    await activitylogsearch.verifySearchOnactivitylogPage();
