...
const { GeneralSettingsImage } = require('../pages/GeneralSettingsImage');
const credentials = require('../config/Credential');

test('generalsettingsimageTest', async ({ browser }) => {
   ...
   const generalsettingsimage = new GeneralSettingsImage(page);
    ...
    await  generalsettingsimage.generalsetting();
