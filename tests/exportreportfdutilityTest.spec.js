...
const { ExportReportFDUtility } = require('../pages/ExportReportFDUtility');

const credentials = require('../config/Credential');

test('exportreportfdutilityTest', async ({ browser }) => {
   ...
   const exportreportfdutility = new ExportReportFDUtility(page);
    ...
    await  exportreportfdutility.verifyexportreportonfdutilitypage();
