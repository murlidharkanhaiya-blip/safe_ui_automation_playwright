...
const { DeleteRetaVideo } = require('../pages/DeleteRetaVideo');
const credentials = require('../config/Credential');

test('deleteretainvideoTest', async ({ browser }) => {
    ...
    const deleteretainvideo = new DeleteRetaVideo(page);
    ...
    await deleteretainvideo.deleteretainvVideo();
