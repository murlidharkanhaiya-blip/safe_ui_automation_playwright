...
const { UtilityStatsSearch } = require('../pages/UtilityStatsSearch');
const credentials = require('../config/Credential');

test('utilitystatssearchTest', async ({ browser }) => {
    ...
    const utilitystatssearch = new UtilityStatsSearch(page);
    ...
    await utilitystatssearch.verifySearchOnutilitystatsPage();
