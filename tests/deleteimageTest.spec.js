...
const { DeleteImage } = require('../pages/DeleteImage');
const credentials = require('../config/Credential');

test('deleteimageTest', async ({ browser }) => {
    ...
    const deleteimage = new DeleteImage(page);
    ...
    await deleteimage.deleteimagesingroup();
