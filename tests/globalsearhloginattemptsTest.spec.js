...
const { GlobalSearchLoginAttempts } = require('../pages/GlobalSearchLoginAttempts');
const credentials = require('../config/Credential');

test('globalsearhloginattemptsTest', async ({ browser }) => {
    ...
    const globalsearhloginattempts = new GlobalSearchLoginAttempts(page);
    ...
    await globalsearhloginattempts.globalsearchloginattemptsviewmorelink();
