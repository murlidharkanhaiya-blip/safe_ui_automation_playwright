...
const { EmployeeExmpted } = require('../pages/EmployeeExmpted');
const credentials = require('../config/Credential');

test('employeeexmptedTest', async ({ browser }) => {
    ...
    const employeeexmpted = new EmployeeExmpted(page);
    ...
    await employeeexmpted.verifyexmptedemployee();
