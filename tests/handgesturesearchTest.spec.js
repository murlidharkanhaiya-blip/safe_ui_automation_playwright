...
const { HandGestureSearch } = require('../pages/HandGestureSearch');
const credentials = require('../config/Credential');

test('handgesturesearchTest', async ({ browser }) => {
    ...
    const handgesturesearch = new HandGestureSearch(page);
    ...
    await  handgesturesearch.verifySearchonhandgesturePage();
