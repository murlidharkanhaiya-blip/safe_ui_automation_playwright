...
const { GlobalSearchByEmpID } = require('../pages/GlobalSearchByEmpID');
const credentials = require('../config/Credential');

test('globalsearchbyempidTest', async ({ browser }) => {
    ...
    const globalsearchbyempid = new GlobalSearchByEmpID(page);
    ...
    // ✅ Step 4: Global search → emp name
    await globalsearchbyempid.searchEmployeeByID();
