...
const { EditEmployee } = require('../pages/EditEmployee');
const credentials = require('../config/Credential');

test('editemployeeTest', async ({ browser }) => {
    ...
    const editemployee = new EditEmployee(page);
    ...
    await editemployee.editupdateEmployee();
