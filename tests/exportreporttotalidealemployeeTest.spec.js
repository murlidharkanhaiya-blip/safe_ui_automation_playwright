...
const { ExportReportTotalIdealEmployee } = require('../pages/ExportReportTotalIdealEmployee');
const credentials = require('../config/Credential');

test('exportreporttotalidealemployeeTest', async ({ browser }) => {
   ...
   const exportreporttotalidealemployee = new ExportReportTotalIdealEmployee(page);
    ...
    await  exportreporttotalidealemployee.verifyexportreportonidealemployeeonpage();
