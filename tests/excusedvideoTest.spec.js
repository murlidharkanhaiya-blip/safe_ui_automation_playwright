...
const { ExcusedVideo } = require('../pages/ExcusedVideo');
const credentials = require('../config/Credential');

test('excusedvideoTest', async ({ browser }) => {
    ...
    const excusedvideo = new ExcusedVideo(page);
    ...
    await excusedvideo.excusedemployeevideo();
