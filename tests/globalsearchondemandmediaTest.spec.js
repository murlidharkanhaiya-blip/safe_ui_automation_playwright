...
const { GlobalSearchOnDemandMedia } = require('../pages/GlobalSearchOnDemandMedia');
const credentials = require('../config/Credential');

test('globalsearchondemandmediaTest', async ({ browser }) => {
    ...
    const globalsearchondemandmedia = new GlobalSearchOnDemandMedia(page);
    ...
    await globalsearchondemandmedia.globalsearchondemandmediaviewmorelink();
