...
const { GlobalSearchTotalExmpted } = require('../pages/GlobalSearchTotalExmpted');
const credentials = require('../config/Credential');

test('globalsearchtotalexmptedTest', async ({ browser }) => {
    ...
    const globalsearchtotalexmpted = new GlobalSearchTotalExmpted(page);
    ...
    await globalsearchtotalexmpted.globalsearchtotalexmptedviewmorelink();
