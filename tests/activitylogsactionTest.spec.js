...
const { ActivityLogsAction } = require('../pages/ActivityLogsAction');
const credentials = require('../config/Credential');

test('activitylogsactionTest', async ({ browser }) => {
   ...
   const activitylogsaction = new ActivityLogsAction(page);
    ...
    await  activitylogsaction.verifyactivitylogsactionview();
