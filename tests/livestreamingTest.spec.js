...
const { LiveStreaming } = require('../pages/LiveStreaming');
const credentials = require('../config/Credential');

test('livestreamingTest', async ({ browser }) => {
    ...
    const livestreaming = new LiveStreaming(page);
    ...
    await livestreaming.employeelivestreaming();
