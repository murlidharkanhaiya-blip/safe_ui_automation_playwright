class ExportReportTotalEmployee {
    constructor(page) {
        this.page = page;

        // Locators
        this.totalemployeeNavViewLocator = "(//div[@class='block-container unique-user total-employee'])[1]";
    ...
    async verifyexportreportontotalemployeepage() {
        await this.page.waitForLoadState('networkidle');

        // Step 1: Scroll to "Total employee" section
        await this.page.locator(this.totalemployeeNavViewLocator).click();
...
module.exports = { ExportReportTotalEmployee };