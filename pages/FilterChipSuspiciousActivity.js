...
class FilterChipSuspiciousActivity {
    constructor(page) {
        this.page = page;

        // Locators
         this.suspiciousactivitynavview="(//span[normalize-space()='Suspicious Activities'])[1]";
    ...
    async verifysuspiciousactivityfilterchip() {
        await this.page.waitForLoadState('networkidle');

        // Step 1: Navigate to utalitystats

        await this.page.locator(this.suspiciousactivitynavview).click();
        ...
        await selectAndApplyFilter("Spoof");
        await selectAndApplyFilter("Shoulder");
        await selectAndApplyFilter("Object");

    }
}

module.exports = { FilterChipSuspiciousActivity };