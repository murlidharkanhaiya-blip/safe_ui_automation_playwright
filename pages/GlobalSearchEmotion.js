...
class GlobalSearchEmotion {
    constructor(page) {
        ...
        this.emotionviewmore = this.page.locator("(//span[@class='view-more-link'][normalize-space()='View More'])[4]");
        this.videotab=this.page.locator("(//div[contains(text(),'Videos')])[2]");
        

        
    }

    async globalsearchemotionviewmorelink() {
        const ID = '145672';
        ...
        await this.emotionviewmore.waitFor({ state: 'visible', timeout: 15000 });
        await this.emotionviewmore.click();
...
module.exports = { GlobalSearchEmotion };