...
class AutoSyncWatcherSearch {
    constructor(page) {
        this.page = page;

        // Locators
        this.utilitystatscardLocator = "(//span[normalize-space()='Utility Stats'])[1]";
        this.autosyncwatcherTablocator="(//div[normalize-space()='Auto Sync Tool/Watcher'])[1]";
        this.utilitystatsfilterchip="(//div[@class='filter-icon hand '])[1]";
        this.filterchipdropdown="(//div[@class='inputBoxDiv ellipsis '])[1]";
        this.selectdropdownvalue="(//a[normalize-space()='All'])[1]";
        this.applybutton="(//button[normalize-space()='APPLY'])[1]";
    ...
    async verifySearchOnautosyncwatchersearchPage() {
    await this.page.waitForLoadState('networkidle');

    // Navigate to Utility Stats page
    await this.page.locator(this.utilitystatscardLocator).click();
    //Click on autosync watcher tab
    await this.page.locator(this.autosyncwatcherTablocator).click();

    // Click filter icon
    await this.page.locator(this.utilitystatsfilterchip).click();

    // Wait and open the Status dropdown
    await this.page.locator(this.filterchipdropdown).click();

    // Select "All" option
    await this.page.locator(this.selectdropdownvalue).click();
...
module.exports = { AutoSyncWatcherSearch };
