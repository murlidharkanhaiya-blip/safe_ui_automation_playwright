...
class FilterChipBulkUpload {
    constructor(page) {
        this.page = page;

        // Locators
        this.FilterchipNavViewLocator = "(//a[@data-testid='nav-link'])[12]";
    ...
    async verifybulkfilterchip() {
        await this.page.waitForLoadState('networkidle');

        // Step 1: Navigate to Manage Employee
        await this.page.locator(this.FilterchipNavViewLocator).click();
        ...
        await selectAndApplyFilter("Successful");
        await selectAndApplyFilter("Partially Successful");
         await selectAndApplyFilter("Failed");
    }
}

module.exports = { FilterChipBulkUpload };