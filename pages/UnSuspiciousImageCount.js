...
class UnSuspiciousImageCount

 {
    constructor(page) {
        ...
        this.unsuspiciouscountviewmore = this.page.locator("(//span[@class='view-more-link'][normalize-space()='View More'])[6]");
        this.closepopup=this.page.locator("(//img[@alt='close popup'])[1]");
        
        
    }

    async globalsearchunsuspiciouscountviewmorelink() {
        const ID = '145672';
        ...
        await this.unsuspiciouscountviewmore.waitFor({ state: 'visible', timeout: 15000 });
        await this.unsuspiciouscountviewmore.click();
...
module.exports = { UnSuspiciousImageCount };