...
this.settingsIcon = this.page
    ...
    .first();
     ...
     //this.settingIcon = "(//*[name()='svg'])[19]";
        ...
        this.livestreamingsettings = this.page.locator("(//span[normalize-space()='Live Streaming Settings'])[1]");
        this.livestreaminggtoggle = this.page.locator("(//div[@class='react-switch-bg'])[1]");
        this.livestreamingduration=this.page.locator("(//input[@id='livestream_duration'])[1]");
        this.maxalivestreaming=this.page.locator("(//div[@class='rangeslider rangeslider-horizontal'])[1]");
...
//live sreaming  toggle
 await this.clickToggle(this.livestreaminggtoggle);
 await this.page.waitForTimeout(500);

  // --- FILL FORM VALUES ---
await this.clearAndFill(this.livestreamingduration, "10");
await this.page.waitForTimeout(500);

//Max Live Streaming Count

 await this.clickToggle(this.maxalivestreaming);
 await this.page.waitForTimeout(500);
