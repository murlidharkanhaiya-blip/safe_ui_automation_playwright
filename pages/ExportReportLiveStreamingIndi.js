class ExportReportLiveStreamingIndi {
    constructor(page) {
        this.page = page;

        // Locators
       this.livestreamingCard = this.page.locator("div.block-container.deleted-images-block").filter({ hasText: "Live Streaming" });
       this.actionbutton=this.page.locator("(//img[@title='View Video Streaming Entities'])[1]")
    ...
    async verifyexportreportonlivestreamingindipage() {
       ...
       await this.page.waitForLoadState('domcontentloaded');
        ...
        await this.actionbutton.waitFor({ state: 'visible', timeout: 5000 });
...
module.exports = { ExportReportLiveStreamingIndi };