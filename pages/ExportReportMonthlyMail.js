class ExportReportMonthlyMail {
    constructor(page) {
        this.page = page;
        this.batchschedulingNavViewLocator = "(//*[name()='svg'])[16]";
        this.monthlymail="(//div[contains(text(),'Monthly Mail')])[1]"
    ...
    async verifyexportreportonmonthlymailpage() {
        ...
        await this.page.locator(this.monthlymail).click();
        await this.page.waitForTimeout(2000);
...
module.exports = { ExportReportMonthlyMail };