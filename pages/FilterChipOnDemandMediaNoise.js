...
class FilterChipOnDemandMediaNoise {
    constructor(page) {
        this.page = page;
        ...
        this.ondemandmediaCard = this.page.locator("div.block-container:has-text('On Demand Media')");
         ...
         // image tab locator
        this.noisetab=this.page.locator("(//div[normalize-space()='Audio'])[1]");
    ...
    async verifyondemandnedianoisefilterchip() {
...
module.exports = { FilterChipOnDemandMediaNoise };