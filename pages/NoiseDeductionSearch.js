...
class NoiseDeductionSearch {
    constructor(page) {
        this.page = page;

        // Locators
        this.noisecardLocator = "(//span[normalize-space()='Noise Detection'])[1]";
    ...
    async verifySearchonnoisedeductionPage() {
        await this.page.waitForLoadState('networkidle');

        // Click on NSFW Activity(s) card
        await this.page.locator(this.noisecardLocator).click();
        ...
        const performSearchAndAssert = async (criteriaText, inputValue, cellSelector, label) => {
            ...
            try {
                ...
                console.warn(`✅ ${label} search result check success for "${inputValue}"`);
            }
        };
...
module.exports = { NoiseDeductionSearch };
