...
class FilterChipUtalityStats {
    constructor(page) {
        ...
        // Locators
        this.UtalitystatsNavViewLocator = "(//span[normalize-space()='Utility Stats'])[1]";
    ...
    async verifyutalitystatsfilterchip() {
        ...
        await this.page.locator(this.UtalitystatsNavViewLocator).click();
        ...
        await selectAndApplyFilter("Inactive");
