class ExportReportDailyMail {
    ...
    async verifyexportreportondailymailpage() {
        ...
        //Step 2:click on daily mail option.
        await this.page.locator(this.dailymail).click();
        await this.page.waitForTimeout(2000);
...
module.exports = { ExportReportDailyMail };