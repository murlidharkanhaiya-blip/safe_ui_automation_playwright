class ExportReportShiftManager {
    constructor(page) {
        this.page = page;
        this.batchschedulingNavViewLocator = "(//*[name()='svg'])[16]";
        this.shiftmanager="(//div[contains(text(),'Shift Manager')])[1]"
    ...
    async verifyexportreportonshiftmanagerpage() {
        ...
        await this.page.locator(this.shiftmanager).click();
        await this.page.waitForTimeout(2000);
...
module.exports = { ExportReportShiftManager };