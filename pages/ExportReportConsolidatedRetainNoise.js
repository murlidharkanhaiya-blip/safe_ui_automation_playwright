class ExportReportConsolidatedRetainNoise {
    constructor(page) {
        this.page = page;

        // Locators
       this.retainentitycardLocator = "(//div[@class='dashboard-box'])[2]";
       this.noisetab="(//div[@class='noise failed-captures btn btn-outline-success '])[1]";
...
module.exports = { ExportReportConsolidatedRetainNoise };