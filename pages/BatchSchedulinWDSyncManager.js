...
class BatchSchedulinWDSyncManager {
    ...
    async Batchschedulingjobwdsyncmanager() {
  ...
  await batchschedulingnav.click();
        ...
        await this.wdsyncmanagerbutton.click();
        await this.page.waitForTimeout(2000);

        await this.createnewscheduler.click();
        await this.page.waitForTimeout(1000);

        const schedulerName = `wdsyncmanager_${Date.now()}`;
...
module.exports = { BatchSchedulinWDSyncManager };