...
class FilterChipTotalEmployee {
    constructor(page) {
        this.page = page;

        // Locators
         this.totalemployeenavview="(//div[@class='block-content'])[9]";
    ...
    async verifytotalemployeefilterchip() {
        await this.page.waitForLoadState('networkidle');

        // Step 1: Navigate to utalitystats

        await this.page.locator(this.totalemployeenavview).click();
        ...
        await selectAndApplyFilter("Verified");
        await selectAndApplyFilter("Unverified");
...
module.exports = { FilterChipTotalEmployee };