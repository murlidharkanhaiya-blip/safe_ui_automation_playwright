class ExportReportSuspiciousVideo {
    constructor(page) {
        this.page = page;

        // Locators
        this.suspiciousactivity = "(//span[normalize-space()='Suspicious Activities'])[1]";
        this.suspiciousvideo="(//div[@class='videos failed-captures btn btn-outline-success '])[1]";
    ...
    async verifyexportreportonsuspiciousactivityvideopage() {
        await this.page.waitForLoadState('networkidle');

       //Click on suspicious activity  nav icon
       await this.page.locator(this.suspiciousactivity).click();
       
      //Click on suspicious activity video tab
      await this.page.locator(this.suspiciousvideo).click();
        // Step 1: Export CSV
...
module.exports = { ExportReportSuspiciousVideo };