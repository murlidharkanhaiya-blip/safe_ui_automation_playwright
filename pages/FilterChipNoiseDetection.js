...
class FilterChipNoiseDetection {
    constructor(page) {
        this.page = page;

        // Improved Locators
        this.noiseDetectionNav = page.locator("span:has-text('Noise Detection')").first();
    ...
    async verifynoisedetectionfilterchip() {
        // ✅ Reset state
        await this.page.waitForLoadState('domcontentloaded');
        await this.page.waitForTimeout(2000);
        ...
        // ✅ Step 1: Click Noise Detection nav/card
        console.log("📊 Looking for Noise Detection...");
        
        await this.noiseDetectionNav.waitFor({ state: 'visible', timeout: 15000 });
        await this.noiseDetectionNav.scrollIntoViewIfNeeded();
        await this.page.waitForTimeout(500);
        await this.noiseDetectionNav.click();
        console.log("✅ Clicked Noise Detection");
        ...
        if (noDataVisible) {
            console.warn("⚠️ No data available on Noise Detection");
            return;
        }
        ...
        // ✅ Step 2: Apply filters (correct names from screenshot)
...
module.exports = { FilterChipNoiseDetection };