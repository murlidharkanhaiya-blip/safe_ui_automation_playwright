...
class BatchSchedulinShiftManager {
    constructor(page) {
        this.page = page;

        this.batchschedulingnavbar = this.page.locator("(//*[name()='svg'])[16]");
       this.shiftmanagerbutton = this.page.locator("(//div[contains(text(),'Shift Manager')])[1]");
    ...
    async Batchschedulingjobshiftmanager() {
        await this.batchschedulingnavbar.click();
        await this.page.waitForTimeout(2000);

        await this.shiftmanagerbutton.click();
        await this.page.waitForTimeout(2000);

        await this.createnewscheduler.click();
        await this.page.waitForTimeout(1000);

        const schedulerName = `shiftmanager_${Date.now()}`;
...
module.exports = { BatchSchedulinShiftManager };