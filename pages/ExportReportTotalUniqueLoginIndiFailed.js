class ExportReportTotalUniqueLoginIndiFailed {
    constructor(page) {
        this.page = page;
    ...
    async verifyexportreportontotaluniqueloginindifailedpage() {
...
module.exports = { ExportReportTotalUniqueLoginIndiFailed };