...
class BatchSchedulingDeactivatedEmployee {
    constructor(page) {
        this.page = page;

        // Locators
        this.batchSchedulingNav = page.locator("div.fixed-left-sidebar li[data-tip='Batch Scheduling'] a[data-testid='nav-link']");
        this.deactivatedEmployeeButton = page.locator("div:has-text('Deactivated Employees')").first();
    ...
    async Batchschedulingjobdeactivatedemployee() {
        // ✅ Reset state
        ...
        // ✅ Click Deactivated Employees tab
        console.log("📋 Clicking Deactivated Employees...");
        await this.deactivatedEmployeeButton.waitFor({ state: 'visible', timeout: 10000 });
        await this.deactivatedEmployeeButton.click();
        await this.page.waitForTimeout(2000);
        await this.waitForLoader();
        console.log("✅ Deactivated Employees tab selected");
        ...
        // ✅ Fill Scheduler Name
        const schedulerName = `deactivateemp_${Date.now()}`;
        ...
        console.log("🎉 Deactivated Employee scheduler created successfully!");
    }
}

module.exports = { BatchSchedulingDeactivatedEmployee };