class ExportReportDeactivatedEmployee {
    constructor(page) {
        this.page = page;
        this.batchschedulingNavViewLocator =".fixed-left-sidebar a[data-testid='nav-link'][href='/batch-scheduling']";
        this.deactivatedemployee="(//div[contains(text(),'Deactivated Employees')])[1]"
    ...
    async verifyexportreportondeactivatedemployeepage() {
        ...
        await this.page.locator(this.deactivatedemployee).click();
        await this.page.waitForTimeout(2000);
...
module.exports = { ExportReportDeactivatedEmployee };