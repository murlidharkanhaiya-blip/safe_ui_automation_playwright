...
class FilterChipRetainEntity {
    constructor(page) {
        this.page = page;

        // Locators
        this.RetainEntityNavViewLocator = "(//div[@class='dashboard-box'])[2]";
    ...
    async verifyretainentityfilterchip() {
        await this.page.waitForLoadState('networkidle');

        // Step 1: Navigate to Manage Employee
        await this.page.locator(this.RetainEntityNavViewLocator).click();
...
module.exports = { FilterChipRetainEntity };